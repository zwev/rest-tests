# This test posts non-default settings to the reader, saves those settings, then reboots the reader.
# After rebooting default settings are posted and checked to ensure reader settings are default, then settings are restored and checked that they are what was originally posted.
