# This test posts non-default settings to the reader, reboots the reader, then checks that settings have been reverted to default.
...
from conftest import defaultset
